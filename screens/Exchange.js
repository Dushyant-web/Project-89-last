...
getData(){
  fetch("http://data.fixer.io/api/latest?access_key=46818d3531f27344cd7a5b6a8a0059b7")
  .then(response=>{
      ...
      return(
        ...
        <KeyboardAvoidingView style={{flex:1,justifyContent:'center', alignItems:'center'}}>
          ...
          <TouchableOpacity
            ...
            onPress = {()=>{this.addItem(this.state.itemName, this.state.description,this.state.itemValue)}}
            >
